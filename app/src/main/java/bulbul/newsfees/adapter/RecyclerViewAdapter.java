package bulbul.newsfees.adapter;
...
import bulbul.newsfees.activities.Anime_Activity;
import bulbul.newsfees.model.Anime;

/**
 * Created by uddip on 26-Mar-18.
 */
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, Anime_Activity.class);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        // Load Image from the internet and set it into image using glide
